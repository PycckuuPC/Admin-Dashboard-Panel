...
export const kanbanGrid = [
  ...
  { headerText: 'Выполнено', keyField: 'Close', allowToggle: true },
];
...
export const links = [
  ...
  },
  {
    ...
    links: [
      ...
      {
        name: 'financial',
        ru: 'Финансовый график',
        icon: <RiStockLine />,
      },
      {
        name: 'color-mapping',
        ru: 'Цветовая диаграмма',
        icon: <BsBarChart />,
      },
      {
        name: 'pyramid',
        ru: 'Пирамидальная диаграмма',
        icon: <GiLouvrePyramid />,
      },
      {
        name: 'stacked',
        ru: 'Многослойная диаграмма',
        icon: <AiOutlineBarChart />,
      },
    ],
  },
